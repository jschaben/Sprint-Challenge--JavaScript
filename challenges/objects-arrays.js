...
const universities = [];
let universities = graduates.map(univ => univ.university)
universities.sort();
...
let lowCaseAnimalNames = zooAnimals.map(animal => animal.animal_name.toLowerCase());
